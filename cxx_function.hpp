...
typename std::enable_if< is_wrapper< target >::value && std::is_base_of< wrapper_base< sig ... >, target >::value,
...
template< typename target_policy, typename allocator_manager, typename ... sig >
struct is_wrapper< wrapper< target_policy, allocator_manager, sig ... > > : std::true_type {};
...
void swap( UNPACK NAME & lhs, UNPACK NAME & rhs ) \
    ...
    { lhs.swap( rhs ); } \
namespace impl { template< __VA_ARGS__ > \
struct is_wrapper< UNPACK NAME > : std::true_type {}; }
